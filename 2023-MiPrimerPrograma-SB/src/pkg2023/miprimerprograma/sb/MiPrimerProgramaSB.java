 ...
 */
package pkg2023.miprimerprograma.sb;
 ...
 */
public class MiPrimerProgramaSB {
    ...
    public static void main(String[] args) {
        ...
        dias = scan.nextInt();
        System.out.print("Ingrese precio de hotel por día: ");
        precioHotelDia = scan.nextFloat();
        System.out.print("Ingrese precio de alimentación por día: ");
        ...
        System.out.println("El monto del hotel es: " + montoHotel);
        System.out.println("El monto de alimentació es: " + montoAlimentacion);
        System.out.println("El monto de otros gastos es: " + montoOtrosGastos);
